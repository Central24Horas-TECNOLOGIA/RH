...
const ERRO_GENERICO =
  'Não encontramos uma prova disponível com os dados informados. Verifique as informaÃ§Ãµes ou tente outro mÃ©todo de acesso.';
const ERRO_GENERICO_TELEFONE =
  'Não encontramos uma prova disponível com os dados informados. Verifique as informaÃ§Ãµes ou solicite apoio ao RH.';
...
function TelaAcesso({
  ...
  const tituloCampo =
    metodo === 'telefone' ? 'Telefone' : metodo === 'codigo' ? 'CÃ³digo da prova' : 'E-mail';
  const textoAjuda =
    metodo === 'telefone'
      ? 'Tente acessar usando o telefone cadastrado pelo RH.'
      : metodo === 'codigo'
        ? 'Se vocÃª Não souber os dados cadastrados, solicite ao RH o cÃ³digo da sua prova.'
        : 'Informe o email cadastrado pelo RH para localizar sua avaliaÃ§Ã£o.';
      ...
      ${provas.length > 1
        ? html`
            <div class="conecta-provas-list">
              <strong>Selecione a avaliaÃ§Ã£o</strong>
              ${provas.map(
                (prova) => html`
                  <button
                    type="button"
                  ...
                  >
                    <span>${prova.vaga || 'AvaliaÃ§Ã£o'}</span>
...
function TelaConfirmacao({ sessao, formulario, erro, salvando, onChange, onConfirmar }) {
  return html`
    <section class="conecta-provas-card">
      <div class="conecta-provas-step">ConfirmaÃ§Ã£o</div>
      <h1>Confirme seus dados</h1>
      <p>Verifique se as informaÃ§Ãµes abaixo estÃ£o corretas antes de iniciar a avaliaÃ§Ã£o.</p>
      ...
      <div class="conecta-provas-context">
  ...
  return html`
    <section class="conecta-provas-card conecta-provas-card-wide">
      ...
      <div class="conecta-provas-rules-grid">
        ...
        ${prova.operacao
          ? html`<span><strong>OperaÃ§Ã£o/cliente</strong>${prova.operacao}</span>`
          : null}
          ...
          ? html`
              <div class="conecta-provas-excel-rules">
                ...
                <ul>
                  ...
                  <li>Confira o arquivo antes de avanÃ§ar.</li>
