...
ACCESS_DENIED_MESSAGE = "Voce nao possui permissao para acessar esta area ou executar esta acao."
...
ROLE_DEFINITIONS: dict[str, RoleDefinition] = {
    ROLE_INTERN: RoleDefinition(
        ...
        name="Estagiario",
        level="Basico",
        description="Operacao principal do processo seletivo.",
    ),
    ROLE_DP: RoleDefinition(
        id=ROLE_DP,
        name="DP",
        level="Alto",
        description="Documentacao, admissao e substituicao operacional do processo seletivo.",
    ),
    ROLE_MANAGER: RoleDefinition(
        id=ROLE_MANAGER,
        name="Gestor",
        level="Avancado",
        description="Decisao, aprovacao, analise e acompanhamento.",
    ),
...
PERMISSION_DEFINITIONS: dict[str, PermissionDefinition] = {
    item.key: item
    for item in (
        _permission("inicio.visualizar", "Geral", "Acessar pagina inicial e resumo do dia."),
        _permission("dashboard.visualizar", "Geral", "Visualizar dashboard e indicadores iniciais."),
        _permission("notificacoes.visualizar", "Notificacoes", "Visualizar notificacoes permitidas."),
        _permission(
            "notificacoes.configurar",
            "Notificacoes",
            "Configurar eventos, destinatarios e regras de alerta.",
            critical=True,
        ),
        ...
        _permission("vagas.encerrar", "Vagas", "Encerrar vaga com confirmacao.", critical=True),
        ...
        _permission("candidatos.editar_basico", "Candidatos", "Editar dados basicos do candidato."),
        ...
        _permission("candidatos.avaliar_curriculo", "Candidatos", "Avaliar curriculo e dar nota."),
        _permission("candidatos.baixar_curriculo", "Candidatos", "Baixar curriculo quando permitido."),
        _permission("candidatos.consultar_historico", "Candidatos", "Consultar historico do candidato."),
        ...
        _permission("candidatos.eliminar", "Candidatos", "Eliminar candidato com motivo obrigatorio.", critical=True),
        _permission("candidatos.reverter_eliminacao", "Candidatos", "Reverter eliminacao com log.", critical=True),
        _permission("candidatos.alterar_nota", "Candidatos", "Alterar nota final consolidada.", critical=True),
        _permission("candidatos.dados_sensiveis", "Candidatos", "Acessar dados sensiveis autorizados."),
        ...
        _permission("entrevistas.marcar_presenca", "Entrevistas", "Marcar presenca ou ausencia."),
        _permission("entrevistas.avaliar", "Entrevistas", "Avaliar entrevista e registrar parecer."),
        _permission("entrevistas.configurar", "Entrevistas", "Configurar tipos, horarios e lembretes.", critical=True),
        ...
        _permission("provas.questoes_criar", "Provas", "Criar questao.", critical=True),
        _permission("provas.questoes_editar", "Provas", "Editar questao.", critical=True),
        _permission("provas.questoes_excluir", "Provas", "Excluir ou desativar questao.", critical=True),
        _permission("provas.configurar_criterios", "Provas", "Alterar criterios de aprovacao.", critical=True),
        ...
        _permission("configuracoes.visualizar", "Configuracoes", "Visualizar configuracoes globais."),
        _permission("configuracoes.editar", "Configuracoes", "Editar configuracoes globais.", critical=True),
        _permission("usuarios.visualizar", "Usuarios", "Listar e consultar usuarios."),
        _permission("usuarios.criar", "Usuarios", "Cadastrar ou adicionar usuario.", critical=True),
        _permission("usuarios.editar", "Usuarios", "Editar usuario.", critical=True),
        _permission("usuarios.excluir", "Usuarios", "Excluir ou desativar usuario.", critical=True),
        _permission("usuarios.ativar", "Usuarios", "Ativar usuario.", critical=True),
        _permission("usuarios.desativar", "Usuarios", "Desativar usuario.", critical=True),
        _permission("usuarios.bloquear", "Usuarios", "Bloquear usuario.", critical=True),
        _permission("usuarios.desbloquear", "Usuarios", "Desbloquear usuario.", critical=True),
        _permission("usuarios.redefinir_senha", "Usuarios", "Definir ou redefinir senha.", critical=True),
        _permission("usuarios.alterar_email", "Usuarios", "Definir, alterar ou redefinir e-mail.", critical=True),
        _permission("usuarios.alterar_perfil", "Usuarios", "Definir ou alterar perfil.", critical=True),
        _permission("usuarios.ver_logs", "Usuarios", "Consultar logs de acesso de usuarios."),
        _permission("lgpd.visualizar", "LGPD", "Consultar informacoes LGPD permitidas."),
        _permission("lgpd.registrar_solicitacao", "LGPD", "Registrar solicitacao LGPD operacional.", critical=True),
        _permission("lgpd.configurar", "LGPD", "Configurar aviso de privacidade e retencao.", critical=True),
        _permission("lgpd.anonimizar", "LGPD", "Executar anonimizacao.", critical=True),
        ...
        _permission("relatorios.visualizar", "Relatorios", "Visualizar relatorios."),
        _permission("relatorios.exportar", "Relatorios", "Exportar relatorios.", critical=True),
        _permission("etapas.configurar", "Etapas e Trilhas", "Configurar etapas do processo.", critical=True),
        _permission("trilhas.configurar", "Etapas e Trilhas", "Configurar trilhas de avaliacao.", critical=True),
    )
}
...
SETTINGS_CATALOGS: dict[str, dict[str, str]] = {
    ...
    "lgpd": {"table": "configuracoes_lgpd", "label": "LGPD e Retencao"},
    "motivos_eliminacao": {"table": "motivos_eliminacao", "label": "Motivos de eliminacao"},
    ...
    "trilhas": {"table": "trilhas", "label": "Trilhas de avaliacao"},
    "provas": {"table": "provas", "label": "Banco de provas"},
    "questoes": {"table": "questoes", "label": "Questoes"},
    "notificacoes": {"table": "notificacoes_regras", "label": "Regras de notificacao"},
}
