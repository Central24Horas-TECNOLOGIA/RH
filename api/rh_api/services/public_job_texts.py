...
DEFAULT_PUBLIC_JOB_TEXTS = {
    "default": {
        "descricao": (
            ...
            "A pessoa selecionada participara das rotinas da area, seguindo os procedimentos internos "
            "e contribuindo para uma entrega organizada, cordial e alinhada aos padroes da Central 24h."
        ),
        "requisitos": [
            "Ensino medio completo ou formacao compativel com a vaga.",
            "Experiencia anterior em atividades relacionadas sera considerada um diferencial.",
            "Boa comunicacao verbal e escrita.",
            "Organizacao, responsabilidade e postura profissional.",
            "Facilidade para aprender sistemas, processos internos e rotinas operacionais.",
            "Disponibilidade para cumprir a jornada e os horarios definidos pelo RH.",
        ],
        "responsabilidades": [
            "Executar as atividades da funcao conforme orientacao da lideranca.",
            "Atender demandas internas e externas com cordialidade, clareza e agilidade.",
            "Registrar informacoes de forma correta nos sistemas e controles definidos.",
            "Cumprir procedimentos, prazos, politicas internas e orientacoes do processo.",
            "Apoiar a equipe na manutencao da qualidade e continuidade das operacoes.",
        ],
    },
    "atendimento": {
        "descricao": (
