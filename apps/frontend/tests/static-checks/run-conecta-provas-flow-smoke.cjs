...
assert.ok(indexHtml.includes('principal.js?v=20260901-user-menu-consolidado'));
assert.ok(principal.includes('aplicacao.js?v=20260901-user-menu-consolidado'));
assert.ok(aplicacao.includes('aplicacao-raiz.js?v=20260901-user-menu-consolidado'));
