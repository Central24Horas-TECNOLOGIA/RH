...
function generalBasicPool() {
  return [
    mcqQ(
      ...
      [
        '(A) Transferir a ligação sem apresentar explicações',
        '(B) Ouvir o cliente com calma e manter uma postura profissional',
        '(C) Responder no mesmo tom utilizado pelo cliente',
        '(D) Encerrar o atendimento rapidamente para reduzir a fila',
      ],
      1,
    ),
    mcqQ(
...
Considerando as informações apresentadas, quantos atendimentos foram realizados no total nesse período? Caso necessário, você pode utilizar a calculadora do Windows para apoiar o cálculo.`,
    ...
    mcqQ(
      ...
      [
        '(A) Passar informações incompletas para agilizar o repasse',
        '(B) Registrar as pendências de forma clara e organizada',
        '(C) Confiar apenas na memória para repassar as atividades',
        '(D) Informar somente o que for urgente e deixar o restante para depois',
      ],
      1,
    ),
    mcqQ(
      ...
      [
        '(A) Atualizar o relatório semanal, por ser uma atividade de rotina',
        '(B) Responder o e-mail sem urgência, para reduzir pendências na caixa de entrada',
        '(C) Corrigir o cadastro bloqueado, por ter impacto mais imediato na operação',
        '(D) Tratar qualquer uma das tarefas, sem necessidade de ordem de prioridade',
      ],
      2,
    ),
    mcqQ(
      ...
      [
        ...
        '(B) Dizer para ele descobrir sozinho, para aprender mais rápido',
        '(C) Orientar de forma rápida e indicar onde localizar o procedimento no sistema',
        '(D) Mandar que ele procure o RH para resolver a dúvida',
      ],
      2,
    ),
  ];
...
function generalAdvPeoplePool() {
  return [
    mcqQ(
      ...
      [
        '(A) Esperar até o fim do dia para avaliar o impacto na operação',
        '(B) Redistribuir a equipe disponível e priorizar as filas mais críticas',
        '(C) Cobrar a equipe pelo aumento da demanda sem reorganizar os recursos',
        '(D) Interromper os acompanhamentos da operação até a situação normalizar',
      ],
      1,
    ),
    mcqQ(
      ...
      [
        '(A) Expor o erro diante da equipe para reforçar a cobrança',
        '(B) Aplicar um feedback individual com orientação objetiva sobre os ajustes necessários',
        '(C) Ignorar o problema, já que o operador apresenta boa postura',
        '(D) Retirar o operador da atividade sem apresentar explicações',
      ],
      1,
    ),
    mcqQ(
      ...
      [
        '(A) Analisar a causa do atraso, o volume da fila, o SLA e a capacidade operacional da equipe',
        '(B) Substituir toda a equipe responsável pela fila para tentar normalizar o cenário',
        '(C) Fechar temporariamente a fila sem comunicação prévia',
        '(D) Informar apenas que a equipe precisa acelerar o ritmo de trabalho',
      ],
      0,
    ),
    mcqQ(
      ...
      [
        '(A) Tempo médio de atendimento e volume tratado',
        '(B) Cor utilizada na planilha de acompanhamento',
        '(C) Duração do horário de almoço da equipe',
        '(D) Quantidade de e-mails pessoais recebidos no dia',
      ],
      0,
    ),
    mcqQ(
      ...
      [
        '(A) Enviar um aviso sem contexto, apenas informando que houve alteração',
        '(B) Explicar o motivo da mudança, o impacto na rotina e a data de início',
        '(C) Alterar o processo sem comunicar a equipe previamente',
        '(D) Esperar que as dúvidas apareçam para só então explicar a mudança',
      ],
      1,
    ),
  ];
...
function generalAdvancedPool() {
  return [
    mcqQ(
      ...
      [
        '(A) A operação melhorou de forma completa, sem qualquer ponto de atenção',
        '(B) Pode ter ocorrido ganho de velocidade, mas com possível queda na qualidade ou na efetividade do atendimento',
        '(C) O aumento do recontato não é relevante para a análise da operação',
        '(D) A melhor solução é reduzir ainda mais o tempo médio de atendimento',
      ],
      1,
    ),
    mcqQ(
...
function techTiBasicPool() {
  return [
    mcqQ(
      ...
      [
        '(A) Verificar se o sistema está acessível e se existe alguma mensagem de erro apresentada na tela',
        '(B) Trocar o mouse utilizado pelo operador',
        '(C) Reiniciar o computador de todos os usuários da operação',
        '(D) Fechar o chamado sem realizar testes iniciais',
      ],
      0,
    ),
    mcqQ(
      ...
      [
        '(A) Porque evita que o atendimento tenha rastreabilidade',
        '(B) Porque facilita o diagnóstico do problema e mantém o histórico da ocorrência',
        '(C) Porque substitui completamente a necessidade de testes técnicos',
        '(D) Porque elimina a participação do usuário na tratativa',
      ],
      1,
    ),
    mcqQ(
      ...
      [
        '(A) Pode haver um problema específico na rede interna ou no serviço do sistema acessado',
        '(B) Houve falta de energia em todo o bairro',
        '(C) O teclado do computador está desconectado',
        '(D) O monitor da estação está desligado',
      ],
      0,
    ),
    mcqQ(
      ...
      [
        '(A) Compartilhar a senha com outro colaborador para agilizar o trabalho',
        '(B) Utilizar credenciais individuais e não repassá-las a outras pessoas',
        '(C) Anotar a senha em papel e deixá-la visível no posto de trabalho',
        '(D) Utilizar a conta de um colega para acessar o sistema',
      ],
      1,
    ),
    mcqQ(
      ...
      [
        '(A) Supor a causa do problema e alterar o ambiente de produção imediatamente',
        '(B) Coletar evidências, testar hipóteses e registrar os resultados obtidos',
        '(C) Ignorar o histórico das ocorrências anteriores',
        '(D) Aguardar para ver se o problema desaparece sozinho',
      ],
      1,
    ),
  ];
...
function techRhBasicPool() {
  return [
    mcqQ(
      ...
      [
        '(A) Uma planilha contendo nome do candidato, etapa do processo e status atualizado',
        '(B) Anotações soltas feitas ao longo do dia, sem padrão definido',
        '(C) Mensagens trocadas de forma dispersa, sem controle centralizado',
        '(D) A memória do recrutador para lembrar em que etapa cada candidato está',
      ],
      0,
    ),
    mcqQ(
      ...
      [
        '(A) Ignorar o contato até que o processo seletivo seja encerrado',
        '(B) Responder com clareza e educação, informando a etapa atual do processo seletivo',
        '(C) Criticar o candidato por insistir em pedir retorno',
        '(D) Divulgar informações ou notas de outros candidatos para justificar a resposta',
      ],
      1,
    ),
    mcqQ(
      ...
      [
        '(A) Agendar todos os candidatos no mesmo horário para ganhar tempo',
        '(B) Definir previamente os horários e os responsáveis por cada entrevista',
        '(C) Permitir que cada candidato escolha qualquer horário sem controle centralizado',
        '(D) Não confirmar a presença dos candidatos antes da entrevista',
      ],
      1,
    ),
    mcqQ(
      ...
      [
        '(A) Informação pública, disponível para qualquer pessoa da empresa',
        '(B) Informação de uso restrito ao processo seletivo',
        '(C) Conteúdo apropriado para compartilhamento em grupos internos sem critério',
        '(D) Material que pode ser enviado a qualquer gestor, mesmo sem participação no processo',
      ],
      1,
    ),
    mcqQ(
      ...
      [
        '(A) Não responder ao candidato após a conclusão da avaliação',
        '(B) Informar o resultado de forma respeitosa, clara e objetiva',
        '(C) Ironizar o desempenho apresentado durante o processo',
        '(D) Bloquear o contato do candidato para evitar novas mensagens',
      ],
      1,
    ),
  ];
...
function techAdmBasicPool() {
  return [
    ...
    mcqQ(
      ...
      [
        '(A) Mapear o processo e identificar o ponto em que a falha está ocorrendo',
        '(B) Trocar toda a equipe envolvida na atividade',
        '(C) Parar de medir os resultados para reduzir a pressão',
        '(D) Remover os controles existentes no processo',
      ],
      0,
    ),
    mcqQ(
      ...
      [
        '(A) Monitoramento das atividades, registro das informações e ações corretivas quando necessário',
        '(B) Apenas opiniões gerais sobre o que está acontecendo na operação',
        '(C) Decisões tomadas sem análise de dados ou contexto',
        '(D) Atividades sem definição de responsáveis',
      ],
      0,
    ),
    mcqQ(
      ...
      [
        '(A) Cruzar informações de volume, capacidade operacional e absenteísmo da equipe',
        '(B) Ignorar o histórico recente da operação',
        '(C) Cobrar a equipe imediatamente sem realizar análise',
        '(D) Esperar até o fechamento do mês para verificar o cenário',
      ],
      0,
    ),
  ];
...
function techTiSpecificPool() {
  return [
    mcqQ(
      ...
      [
        '(A) Repetir comandos sem qualquer critério lógico',
        '(B) Tomar uma decisão com base em uma condição avaliada',
        '(C) Armazenar imagens dentro do código',
        '(D) Desligar a rede quando houver erro',
      ],
      1,
    ),
    mcqQ(
      ...
      [
        '(A) O desempenho das aplicações e serviços executados nesse ambiente',
        '(B) A cor exibida no navegador do usuário',
        '(C) O layout visual de um e-mail corporativo',
        '(D) O volume de café consumido pela equipe de TI',
      ],
      0,
    ),
    mcqQ(
      ...
      [
        '(A) Utilizar senhas compartilhadas entre membros da equipe',
        '(B) Aplicar o princípio do privilégio mínimo e utilizar autenticação adequada',
        '(C) Manter credenciais genéricas para facilitar o acesso',
        '(D) Permitir acesso irrestrito a qualquer usuário autenticado',
      ],
      1,
    ),
    mcqQ(
      ...
      [
        '(A) Uma tela utilizada apenas para exibição de relatórios',
        '(B) Uma interface de comunicação entre sistemas e aplicações',
        '(C) Um tipo de banco de dados físico instalado localmente',
        '(D) Uma planilha protegida utilizada para controle interno',
      ],
      1,
    ),
    mcqQ(
      ...
      [
        '(A) Falhas possíveis, observabilidade do ambiente e estratégias de contingência',
        '(B) Somente o nome do endpoint principal da integração',
        '(C) Apenas a cor do sistema envolvido no processo',
        '(D) A ausência de logs para simplificar o ambiente',
      ],
      0,
    ),
  ];
...
function techAdmSpecificPool() {
  return [
    ...
    mcqQ(
      ...
      [
        '(A) Analisar a causa do cenário, a escala aplicada e o perfil da demanda recebida',
        '(B) Trocar a cor do dashboard para facilitar a visualização',
        '(C) Parar de acompanhar os indicadores até a operação estabilizar',
        '(D) Cobrar a equipe imediatamente, sem investigar o contexto',
      ],
      0,
    ),
    mcqQ(
    ...
    mcqQ(
      ...
      [
        '(A) Mapear a aderência ao processo e identificar oportunidades de melhoria',
        '(B) Aumentar o ruído na operação',
        '(C) Eliminar a necessidade de treinamentos futuros',
        '(D) Esconder falhas existentes no atendimento',
      ],
      0,
    ),
    mcqQ(
      ...
      [
        '(A) Substituem completamente qualquer tipo de análise mais detalhada',
        '(B) Ajudam a visualizar tendências e apoiam a tomada de decisão',
        '(C) Servem apenas para impressão de relatórios',
        '(D) Dispensam a conferência ou validação dos dados apresentados',
      ],
      1,
    ),
  ];
...
function analysisEvalPool() {
  return [
    mcqQ(
      ...
      [
        '(A) A operação passou a ter excesso de capacidade disponível',
        '(B) A operação pode estar subdimensionada para o novo volume de demanda',
        '(C) O principal problema está relacionado apenas à cor do dashboard',
        '(D) Esse cenário não indica nenhum impacto operacional relevante',
      ],
      1,
    ),
    mcqQ(
      ...
      [
        '(A) Ação definida, responsável pela execução e prazo estabelecido',
        '(B) Apenas opiniões gerais sobre o cenário analisado',
        '(C) Somente o nome do cliente ou da operação envolvida',
        '(D) Informações sem definição de responsável',
      ],
      0,
    ),
  ];
...
function techLogicPool() {
  return [
    mcqQ(
      ...
      [
        '(A) Os usuários podem ficar impedidos de acessar o sistema normalmente',
        '(B) A impressora da operação ficará sem tinta',
        '(C) O monitor dos computadores mudará de cor automaticamente',
        '(D) Toda a internet do bairro será interrompida',
      ],
      0,
    ),
    mcqQ(
      ...
      [
        '(A) Coletar logs, registrar o horário e analisar o contexto em que o erro ocorreu',
        '(B) Reiniciar os serviços imediatamente, sem qualquer registro da ocorrência',
        '(C) Ignorar o problema por não acontecer o tempo todo',
        '(D) Alterar o ambiente de produção sem plano ou evidência',
      ],
      0,
    ),
  ];
  ...
  return [
    mcqQ(
      ...
      [
        ...
        '(B) João',
        '(C) Pedro',
        '(D) Todos realizaram a mesma quantidade',
      ],
      1,
    ),
    mcqQ(
    ...
    mcqQ(
      ...
      [
        '(A) A função SUM não existe no Excel',
        '(B) Falta fechar o parêntese ao final da fórmula',
        '(C) O intervalo informado está grande demais para ser usado',
        '(D) A fórmula está correta e pode ser utilizada normalmente',
      ],
      1,
    ),
    mcqQ(
